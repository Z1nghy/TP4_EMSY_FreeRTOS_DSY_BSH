...
Voici donc ce que nous avons mesuré sur les trois LED's : 
...
Voici la configuration de mesure:
  ...
  - Trigger sur le Chanel 2
  - Base de temps à 20ms
  - 
### Saisie de un caractères 
Voici notre mesure lorsqu'un seul caractère est envoyé à la fois :
<img width="1280" height="824" alt="image (2)" src="https://github.com/user-attachments/assets/93b2a2b1-2bde-44ad-9e08-4c8f16a59256" />

Le signal bas du canal 2 met clairement en évidence la transmission d'un caractère.
...
### Saisie de plusieure caractères
Voici notre mesure lorsque plusieurs caractères sont envoyés à la fois :
